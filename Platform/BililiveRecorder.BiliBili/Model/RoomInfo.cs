...
internal class RoomInfo
{
    ...
    public Common.Api.Model.RoomInfo ToCommonRoomInfo()
    {
        return new Common.Api.Model.RoomInfo
        {
            Room = new Common.Api.Model.RoomInfo.InnerRoomInfo
            {
                AreaId = Room.AreaId,
                Uid = Room.Uid,
                RoomId = Room.RoomId,
            ...
            User = new Common.Api.Model.RoomInfo.InnerUserInfo
            {
                Name = User.BaseInfo.Name
            }
        };
    }
}
