...
#pragma warning disable VSTHRD100 // Avoid async void methods
    private async void TestFileNameTemplate_Button_Click(object? sender, RoutedEventArgs routedEventArgs)
#pragma warning restore VSTHRD100 // Avoid async void methods
    {
        if (globalConfig is not { } config)
            return;
        ...
        try
        {
            ...
            FileNameTestResultArea.DataContext = output;
        }
        catch (Exception ex)
        {
